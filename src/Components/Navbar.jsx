    ...
    return (
        <div className="flex-shrink-0 w-64 bg-gray-800">
          <div className="flex items-center justify-center h-16 bg-gray-900">
            <span className="text-white text-xl font-semibold">Clinica Odontologica  <br /> By <span>Marco Savarino</span></span>
          </div>
          <nav className="mt-10">
            ...
            <Link to="/pacientes" className="flex items-center p-2 text-gray-300 hover:bg-gray-700 hover:text-white">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
